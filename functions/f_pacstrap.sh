...
ask_packages() {
        ...
        while true; do
                echo -e "${C_CYAN}:: ${C_WHITE}Do you want to add networking tools (e.g., nload, nethogs, jnettop, iptraf-ng, tcpdump, nmap, bind-tools, ldns, etc.) [Y/n] -> ${NO_FORMAT} \c" 
        ...
        while true; do
                echo -e "${C_CYAN}:: ${C_WHITE}Do you want to add helping tools (e.g., tealdeer, man, texinfo, etc.) [Y/n] -> ${NO_FORMAT} \c"
        ...
        while true; do
                echo -e "${C_CYAN}:: ${C_WHITE}Do you want to add monitoring tools (e.g., btop, htop, bmon, etc.) [Y/n] -> ${NO_FORMAT} \c"
